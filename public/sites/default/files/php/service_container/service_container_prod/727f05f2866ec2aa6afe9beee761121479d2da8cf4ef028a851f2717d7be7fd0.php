...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'authentication.oauth' => 'getAuthentication_OauthService',
    ...
    protected function getAuthenticationService()
    {
        ...
        $instance->addProvider($this->get('authentication.oauth'), 'authentication.oauth', 100);
    ...
    /**
     * Gets the 'authentication.oauth' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\oauth\Authentication\Provider\OAuthDrupalProvider A Drupal\oauth\Authentication\Provider\OAuthDrupalProvider instance.
     */
    protected function getAuthentication_OauthService()
    {
        $this->services['authentication.oauth'] = $instance = new \Drupal\oauth\Authentication\Provider\OAuthDrupalProvider();

        $instance->_serviceId = 'authentication.oauth';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'oauth' => array(
                    'type' => 'module',
                    'pathname' => 'modules/oauth/oauth.info.yml',
                    'filename' => 'oauth.module',
                ),
                'options' => array(
                    'type' => 'module',
                ...
                'twitter' => array(
                    'type' => 'module',
                    'pathname' => 'modules/twitter/twitter.info.yml',
                    'filename' => 'twitter.module',
                ),
                'user' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\oauth' => 'modules/oauth/src',
                ...
                'Drupal\\twitter' => 'modules/twitter/src',
